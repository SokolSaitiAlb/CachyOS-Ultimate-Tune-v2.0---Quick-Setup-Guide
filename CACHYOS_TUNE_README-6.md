...
### v2.0 (Current) ⭐
- ✨ Complete rewrite with 14+ major improvements
...
- ➕ Btrfs snapshot support
- ➕ **NEW: GPU Shader Cache 12GB optimization**
- ➕ **NEW: Browser Hardware Acceleration (Brave + Firefox)**
- ➕ **NEW: scx_bpfland Advanced Scheduler (optional)**
- ➕ **NEW: CoreCtrl as optional GPU management tool**
